...
topics = ['china', 'nuclear energy', 'nuclear fission', 'small modular reactor', 'nuclear fusion', 'spacex', 'james webb', 'inflation', 'real estate', 'sp 500', 'blue origin', 'seattle', 'stem cell', 'superconductor', 'israel', 'palestine', 'hamas', 'open ai', 'microsoft', 'github', 'akira', 'cryonics', 'UUUU', 'NLR', 'stellantis', 'rocket lab', 'NUKR', 'Musk', 'DOGE', 'External Revenue Service', 'Stock Market', 'Stock Futures', 'recession', 'IPO', 'pre-market']
